...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/27 20:14:32 by hes-saqu          #+#    #+#             */
/*   Updated: 2024/04/27 20:14:34 by hes-saqu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ra(t_stack **stack_a_head, int is_checker)
{
	...
	if (*stack_a_head == NULL)
		return (write_move(5, is_checker));
	a_tmp = (*stack_a_head);
...
int	rb(t_stack **stack_b_head, int is_checker)
{
	...
	if (*stack_b_head == NULL)
		return (write_move(6, is_checker));
	b_tmp = (*stack_b_head);
...
int	rra(t_stack **stack_a_head, int is_checker)
{
	...
	if (*stack_a_head == NULL)
		return (write_move(7, is_checker));
...
int	rrb(t_stack **stack_b_head, int is_checker)
{
	...
	if (*stack_b_head == NULL)
		return (write_move(8, is_checker));
